...
if __name__ == '__main__':
    ...
    for i in range(3):
        client.udt_send(2,0,0, 'Sample data send mucho data so much data that is trying to get a bunch of information across while taking a long time to say it %d' % i)
